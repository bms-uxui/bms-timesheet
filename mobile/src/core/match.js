// Pure date+time matching logic. Same algorithm as the web version —
// classify a photo as clock-in (≤ 08:30) or clock-out (> 17:30), pair
// best photo per slot per missing day.
